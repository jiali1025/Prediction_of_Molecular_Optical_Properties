...
def data_cv ( type , data_path ) :
    train_data = pd.read_csv ( os.path.join ( data_path , type + '_data.csv' ) )
...
if __name__ == '__main__' :
    ...
    data_path = (os.path.join ( dataLocation , 'ori_data_all' ))

    resultSaveLocation = '../results/ori_all_result/'
    if not os.path.exists ( resultSaveLocation ) :
        os.makedirs ( resultSaveLocation )

    x_morg_train , y_morg_train , x_morg_train_val , \
    x_morg_val , y_morg_train_val , y_morg_val = data_cv ( 'morg' , data_path )

    x_rd_train , y_rd_train , x_rd_train_val , \
    x_rd_val , y_rd_train_val , y_rd_val = data_cv ( 'rd' , data_path )

    x_AP_train , y_AP_train , x_AP_train_val , \
    x_AP_val , y_AP_train_val , y_AP_val = data_cv ( 'AP' , data_path )

    x_torsion_train , y_torsion_train , x_torsion_train_val , \
    x_torsion_val , y_torsion_train_val , y_torsion_val = data_cv ( 'torsion' , data_path )

    x_descriptors_train , y_descriptors_train , x_descriptors_train_val , \
    x_descriptors_val , y_descriptors_train_val , y_descriptors_val = data_cv ( 'descriptors' , data_path )
    ...
    lr_cv ( x_descriptors_train , y_descriptors_train , 'descriptors' , save_path )
    ...
    knn_cv ( x_descriptors_train , y_descriptors_train , 'descriptors' , save_path )
    ...
    gb_cv ( x_descriptors_train , y_descriptors_train , 'descriptors' , save_path )
    ...
    rf_cv ( x_descriptors_train , y_descriptors_train , 'descriptors' , save_path )
    ...
    nn_cv ( x_descriptors_train , y_descriptors_train , 'descriptors' , save_path )
