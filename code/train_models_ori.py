...
if __name__ == '__main__' :
    ...
    x_descriptors_train10 , x_descriptors_test10 , y_descriptors_train10 , y_descriptors_test10 , x_descriptors_train_val ,\
    x_descriptors_val , y_descriptors_train_val , y_descriptors_val = data_cv ( nfold , 'descriptors' , data_path )
    ...
    lr_cv ( x_torsion_train10 , y_torsion_train10 , x_torsion_test10 , y_torsion_test10 , 'torsion' , save_path ,
            nfold )
    lr_cv ( x_descriptors_train10 , y_descriptors_train10 , x_descriptors_test10 , y_descriptors_test10 ,
            'descriptors' , save_path , nfold )
    ...
    knn_cv ( x_torsion_train10 , y_torsion_train10 , x_torsion_test10 , y_torsion_test10 , 'torsion' , save_path ,
             nfold )
    knn_cv ( x_descriptors_train10 , y_descriptors_train10 , x_descriptors_test10 , y_descriptors_test10 ,
             'descriptors' , save_path , nfold )
    ...
    gb_cv ( x_torsion_train10 , y_torsion_train10 , x_torsion_test10 , y_torsion_test10 , 'torsion' , save_path ,
            nfold )
    gb_cv ( x_descriptors_train10 , y_descriptors_train10 , x_descriptors_test10 , y_descriptors_test10 ,
            'descriptors' , save_path , nfold )
    ...
    rf_cv ( x_torsion_train10 , y_torsion_train10 , x_torsion_test10 , y_torsion_test10 , 'torsion' , save_path ,
            nfold )
    rf_cv ( x_descriptors_train10 , y_descriptors_train10 , x_descriptors_test10 , y_descriptors_test10 ,
            'descriptors' , save_path , nfold )
    ...
    nn_cv ( x_torsion_train10 , y_torsion_train10 , x_torsion_test10 , y_torsion_test10 , 'torsion' , save_path ,
            nfold )
    nn_cv ( x_descriptors_train10 , y_descriptors_train10 , x_descriptors_test10 , y_descriptors_test10 ,
            'descriptors' , save_path , nfold )
